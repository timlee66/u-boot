...
#define msgData1						HW_DWORD(CORE_MSG_BA+0x44)	// Data Register 1
#define msgData2						HW_DWORD(CORE_MSG_BA+0x48)	// Data Register 2
#define msgData3						HW_DWORD(CORE_MSG_BA+0x4C)	// Data Register 2

// Parameters and data passed between Host and Core, for executing functions
#define msgCmdParam1					HW_DWORD(CORE_MSG_BA+0x60)	
#define msgCmdParam2					HW_DWORD(CORE_MSG_BA+0x64)
#define msgCmdParam3					HW_DWORD(CORE_MSG_BA+0x68)
#define msgCmdParam4					HW_DWORD(CORE_MSG_BA+0x6C)
#define msgCmdParam5					HW_DWORD(CORE_MSG_BA+0x70)
#define msgCmdParam6					HW_DWORD(CORE_MSG_BA+0x74)
#define msgCmdParam7					HW_DWORD(CORE_MSG_BA+0x78)
#define msgCmdParam8					HW_DWORD(CORE_MSG_BA+0x7C)
#define msgCmdParam9					HW_DWORD(CORE_MSG_BA+0x80)	// Large data buffer passed between Host and Core
...
#if 0
#ifdef _MAIN
extern Template_Parameters Template_Params = {PRE_SILICON,DEBUG, 0x80, MAIN_RAM, JTAG, 0, 0,0};
#else
