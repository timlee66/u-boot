...
#define MC_IRQ			    (57)  /** Memory Controler IRQ  */
#define TIMER_IRQ			(27)  /** Timer IRQ  */



#define GIC_BASE                (0xDFFF9000)
...
#define GICC_CTLR_ENABLE			(0x3)	/* Enable GICC */
...
#define GIC_GICD_CTLR_ENABLE	(0x3)	/* Enable GICD */
...
void gic_v2_initialize(irq_no irq, unsigned int target);
void gic_v2_eoi(irq_no irq);
int gic_v2_find_pending_irq(irq_no *irqp);
