...
#define CONFIG_EXTRA_ENV_SETTINGS  \
        ...
        "mtest3_check=if mtest 0x4000000 0x4800000 0x89abcdef 0x100; then setexpr mtest3_passcount ${mtest3_passcount} + 0x1; mw.l 0xfffb0130 ${mtest3_passcount}; else setexpr mtest3_failcount ${mtest3_failcount} + 0x1; mw.l 0xfffb0134 ${mtest3_failcount}; fi\0"    \
        ...
        "mtest3_result=if itest.l *fffb0134 != 0; then echo ***MTEST3-FAIL!***; else echo ***MTEST3-PASS!***; fi; echo MTEST3 pass count!; md.l 0xfffb0130 1; echo MTEST3 fail count!; md.l 0xfffb0134 1\0"    \
        "mtest2_clr_mem=mw.b 0x3000000 0x00 0x800000\0"    \
        "mtest2_check=if mtest 0x3000000 0x3800000 0xfedcba98 0x100; then setexpr mtest2_passcount ${mtest2_passcount} + 0x1; mw.l 0xfffb0120 ${mtest2_passcount}; else setexpr mtest2_failcount ${mtest2_failcount} + 0x1; mw.l 0xfffb0124 ${mtest2_failcount}; fi\0"    \
        ...
        "mtest2_result=if itest.l *fffb0124 != 0; then echo ***MTEST2-FAIL!***; else echo ***MTEST2-PASS!***; fi; echo MTEST2 pass count!; md.l 0xfffb0120 1; echo MTEST2 fail count!; md.l 0xfffb0124 1\0"    \
        "mtest1_clr_mem=mw.b 0x2000000 0x00 0x800000\0"    \
        "mtest1_check=if mtest 0x2000000 0x2800000 0x76543210 0x100; then setexpr mtest1_passcount ${mtest1_passcount} + 0x1; mw.l 0xfffb0110 ${mtest1_passcount}; else setexpr mtest1_failcount ${mtest1_failcount} + 0x1; mw.l 0xfffb0114 ${mtest1_failcount}; fi\0"    \
        ...
        "mtest1_result=if itest.l *fffb0114 != 0; then echo ***MTEST1-FAIL!***; else echo ***MTEST1-PASS!***; fi; echo MTEST1 pass count!; md.l 0xfffb0110 1; echo MTEST1 fail count!; md.l 0xfffb0114 1\0"    \
        "mtest0_clr_mem=mw.b 0x1000000 0x00 0x800000\0"    \
        "mtest0_check=if mtest 0x1000000 0x1800000 0x01234567 0x100; then setexpr mtest0_passcount ${mtest0_passcount} + 0x1; mw.l 0xfffb0100 ${mtest0_passcount}; else setexpr mtest0_failcount ${mtest0_failcount} + 0x1; mw.l 0xfffb0104 ${mtest0_failcount}; fi\0"    \
        ...
        "mtest0_result=if itest.l *fffb0104 != 0; then echo ***MTEST0-FAIL!***; else echo ***MTEST0-PASS!***; fi; echo MTEST0 pass count!; md.l 0xfffb0100 1; echo MTEST0 fail count!; md.l 0xfffb0104 1\0"    \
        ...
        "usbh1_check_blocks=if cmp.b 0x500000 0x600000 0x2000; then setexpr usbh1_passcount ${usbh1_passcount} + 0x1; mw.l 0xfffb0010 ${usbh1_passcount}; else setexpr usbh1_failcount ${usbh1_failcount} + 0x1; mw.l 0xfffb0014 ${usbh1_failcount}; fi; run usbh1_clr_mem\0"    \
        ...
        "usbh1_result=if itest.l *fffb0014 != 0; then echo ***USBH1-FAIL!***; else echo ***USBH1-PASS!***; fi; echo USBH1 pass count!; md.l 0xfffb0010 1; echo USBH1 fail count!; md.l 0xfffb0014 1\0"    \
        "usbh2_clr_mem=mw.b 0xc00000 0x00 0x2000\0"    \
        "usbh2_check_blocks=if cmp.b 0xc00000 0xd00000 0x2000; then setexpr usbh2_passcount ${usbh2_passcount} + 0x1; mw.l 0xfffb0140 ${usbh2_passcount}; else setexpr usbh2_failcount ${usbh2_failcount} + 0x1; mw.l 0xfffb0144 ${usbh2_failcount}; fi; run usbh2_clr_mem\0"    \
        ...
        "usbh2_result=if itest.l *fffb0144 != 0; then echo ***USBH2-FAIL!***; else echo ***USBH2-PASS!***; fi; echo USBH2 pass count!; md.l 0xfffb0140 1; echo USBH2 fail count!; md.l 0xfffb0144 1\0"    \
