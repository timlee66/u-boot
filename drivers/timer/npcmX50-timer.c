...
/* get timer count */
static int npcmX50_timer_get_count(struct udevice *dev, u64 *count)
{
...
U_BOOT_DRIVER(npcmX50_timer) = {
	...
	.ofdata_to_platdata = npcmX50_timer_ofdata_to_platdata,
	.priv_auto_alloc_size = sizeof(struct npcmX50_timer_priv),
